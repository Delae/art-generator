...
public class Ocean extends Art {
	...
	private List<int[]> xWaves = new ArrayList<>();
	private List<int[]> yWaves = new ArrayList<>();
	...
	private List<int[]> xShapes = new ArrayList<>();
	private List<int[]> yShapes = new ArrayList<>();
