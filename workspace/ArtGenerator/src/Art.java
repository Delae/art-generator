...
public class Art {
	...
	// protected BackGroundEnum backGroundStyle = BackGroundEnum.GRADIENT;
	// protected BackGroundEnum backGroundStyle = BackGroundEnum.HALO;
	// protected BackGroundEnum backGroundStyle = BackGroundEnum.STRIPES;
	// protected BackGroundEnum backGroundStyle = BackGroundEnum.OCEAN;
